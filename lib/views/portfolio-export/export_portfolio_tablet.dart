...
class ExportPortfolioViewTablet extends StatefulWidget {
  const ExportPortfolioViewTablet({super.key});

  @override
  State<ExportPortfolioViewTablet> createState() => _ExportPortfolioViewTabletState();
}

class _ExportPortfolioViewTabletState extends State<ExportPortfolioViewTablet> {
  int currentIndex = 0;
  Timer? timer;
