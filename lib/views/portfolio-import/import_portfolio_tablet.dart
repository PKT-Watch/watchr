...
class ImportPortfolioViewTablet extends StatefulWidget {
  const ImportPortfolioViewTablet({super.key});

  @override
  State<ImportPortfolioViewTablet> createState() => _ImportPortfolioViewTabletState();
}

class _ImportPortfolioViewTabletState extends State<ImportPortfolioViewTablet> {
  int totalChunks = 0;
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Padding(
                        padding: EdgeInsets.all(32.0),
                        child: Text(
                          "Any portfolios on this device will be deleted.",
